...
def game_loop(screen, level_number):
    ...
    knight_lives = 3  # ==================== MODIFICATO: 3 vite fisse ====================
    ...
    num_enemies = 5  # ==================== MODIFICATO: Numero fisso ====================
    
    # Crea nemici in posizioni random
    ...
    while running:
        ...
        for enemy in enemies:
            ...
            # ==================== MODIFICATO: Toglie 1 vita invece di danno graduale ====================
            ...
            # ==================== MODIFICATO: Nemico muore con un colpo ====================
            if is_attacking:
                if direction == "right":
        ...
        # ==================== MODIFICATO: Disegna nemici senza barra vita ====================
        for enemy in enemies:
            if enemy['alive']:
        ...
        # ==================== MODIFICATO: HUD con vite e nemici rimasti ====================
